...
public class RetractMessageActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        et_conv_username = (EditText) findViewById(R.id.et_retract_target_username);
        et_conv_appkey = (EditText) findViewById(R.id.et_retract_target_appkey);
        et_conv_gid = (EditText) findViewById(R.id.et_retract_target_gid);
        et_message_server_id = (EditText) findViewById(R.id.et_retract_message_server_id);
    ...
    public void onClick(View v) {
        ...
        String msgId = et_message_server_id.getText().toString();
        ...
        if (!TextUtils.isEmpty(username)) {
            ...
            try {
                ...
                Toast.makeText(this, "请输入正确的gid", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
                return;
            }
        } else {
