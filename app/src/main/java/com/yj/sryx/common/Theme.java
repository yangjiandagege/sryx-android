...
public enum Theme {
    ...
    spe(R.color.theme_spe_primary, R.color.theme_spe_primary_dark,
            R.color.theme_spe_background, R.color.theme_spe_text,
            R.color.theme_spe_accent, R.style.AppTheme_Spe);
