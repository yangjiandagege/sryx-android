...
public class GameRecordJudgeFragment extends Fragment {
    ...
    private void initLayout() {
        ...
        mRecordAdapter = new GameRecordJudgeStickyGridAdapter(mActivity, mRoleList);
