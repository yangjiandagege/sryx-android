...
public class GameChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public GameChatAdapter(Context context, List<ChatMessage> messageList) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(R.layout.item_game_chat_message,parent,false);
