...
public class StringUtils {
     ...
     * 取数字
     */
    public static String getDigitStr(String str){
    ...
    /**
     * 计算两个String相减的方法，其中String中存的是double类型的数据
     * @param meiosisStr
     * @param minuendStr
     * @return
     */
    public static String stringSubtractString(String meiosisStr ,String minuendStr) {
        double meiosis, minuend, result;
        if (StringUtils.isEmpty(meiosisStr)) {
            meiosis = 0;
        } else {
            meiosis = Double.valueOf(meiosisStr);
        }
        if (StringUtils.isEmpty(minuendStr)) {
            minuend = 0;
        } else {
            minuend = Double.valueOf(minuendStr);
        }
        if (meiosis > minuend) {
            result = PreciseCompute.sub(meiosis, minuend);
        } else {
            result = 0;
        }
    ...
    /**
     * 计算两个String相加的方法，其中String中存的是double类型的数据
     * @param meiosisStr
     * @param minuendStr
     * @return
     */
    public static String stringPlusString(String meiosisStr ,String minuendStr) {
        double meiosis, minuend, result;
        if (StringUtils.isEmpty(meiosisStr)) {
            meiosis = 0;
        } else {
        ...
        result = PreciseCompute.add(meiosis, minuend);
     ...
     * @return
     */
    public static String addElementWithComma(String original ,String additive) {
        String originalTemp;
        originalTemp = original;
        if(originalTemp != null) {
            originalTemp = originalTemp + "," + additive;
        }else {
            originalTemp = additive;
        }
        return originalTemp;
    }
