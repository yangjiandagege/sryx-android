...
public final class EncodingHandler {
    ...
    public static Bitmap createBarCode128(String str, Integer width, Integer height) throws Exception{
        BitMatrix bitMatrix = new MultiFormatWriter().encode(str, BarcodeFormat.CODE_128, width, height, getEncodeHintMap());
        return BitMatrixToBitmap(bitMatrix);
    }
    public static Bitmap createBarCode39(String str, Integer width, Integer height) throws Exception{
        BitMatrix bitMatrix = new MultiFormatWriter().encode(str, BarcodeFormat.CODE_39, width, height, getEncodeHintMap());
        return BitMatrixToBitmap(bitMatrix);
    }
    public static Bitmap createBarCode93(String str, Integer width, Integer height) throws Exception{
        BitMatrix bitMatrix = new MultiFormatWriter().encode(str, BarcodeFormat.CODE_93, width, height, getEncodeHintMap());
        return BitMatrixToBitmap(bitMatrix);
    }
    /**
     * 获得设置好的编码参数
